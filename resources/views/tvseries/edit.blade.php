...
<div class="ms-5 mt-5 me-5 d-flex justify-content-center" style="width: auto">
    <form action="{{route('editTVSeries')}}" method="POST">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="number" name="seasons" class="form-control" id="seasons" value="{{$seasons}}" required>
        </div>
        <div class="mb-3">
            <label for="episodes" class="form-label">Episodes</label>
            <input type="number" name="episodes" class="form-control" id="episodes" value="{{$episodes}}" required>
        </div>
        <div class="mb-3">
