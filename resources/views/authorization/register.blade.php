              ...
              <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <input name="name" value="{{old('name')}}" type="text" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" />
                ...
                <br><br>
                <a href="login" class="mt-4 w-full bg-gradient-to-tr from-blue-600 to-indigo-600 text-indigo-100 py-2 rounded-md text-lg tracking-wide">Already a user ? Login</a>
              </div>
            </form>
          </div>
    </body>
